...
import type { FeedEvent } from 'src/data/nullmessung';

import { Label } from 'src/components/label';
import { Iconify } from 'src/components/iconify';

// extraEvents lets a caller inject additional feed entries (e.g. a Track 1
// versioned-import alert) without editing the generator-owned agentFeed
// array in src/data/nullmessung.ts (see DATASET.md:50).
export type AgentFeedExtraEvent = FeedEvent & { onAction?: () => void };
...
export function AgentFeed({ extraEvents = [] }: { extraEvents?: AgentFeedExtraEvent[] }) {
  const events: AgentFeedExtraEvent[] = [...extraEvents, ...agentFeed];
