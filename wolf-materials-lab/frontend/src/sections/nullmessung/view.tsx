...
import { frEvent } from 'src/data/fr-evidence';
import {
  fmtEURk,
  rawSamples,
  refProducts,
...
import { FrEvidencePanel } from './fr-evidence-panel';
    ...
    <DashboardContent maxWidth="xl">
      ...
      <Grid container spacing={3}>
        ...
        <Grid size={12}>
          <Card>
            ...
            <AgentFeed
              extraEvents={[
                {
                  ts: frEvent.effectiveDate,
                  channel: 'dashboard',
                  kind: 'decision',
                  de: `${frEvent.id}: sup-aster subset corrected in FR (${frEvent.mode}). Recomputed finding requires review.`,
                  en: `${frEvent.id}: sup-aster subset corrected in FR (${frEvent.mode}). Recomputed finding requires review.`,
                  action: 'Review FR finding',
                },
              ]}
            />
          </Card>
        ...
        <Grid size={12}>
          <Card>
            <CardHeader
              title={<Typography sx={demoTitleSx}>Track 1: FR evidence engine (UPD-FR-002)</Typography>}
              subheader="Source update, affected rows and human approval boundary"
            />
            <Box sx={{ ...demoRuleSx, mb: 1 }} />
            <FrEvidencePanel />
          </Card>
